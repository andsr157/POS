<html>
    <head>
        <title>P-Store - Print nota</title>
        <style type="text/css">
        ...
        <div class="content">
            ...
            <div class="transaction">
                <table class="transaction-table" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td colspan="2"></td>
                        <td style="border-top:1px dahsed; text-align:right; padding:5px 0">Grand Total </td>
                        <td style="border-top:1px dahsed; text-align:right; padding:5px 0">
                            <?=$sale->final_price?>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2"></td>
                        <td style="border-top:1px dahsed; text-align:right; padding-top:5px">Cash</td>
                        <td style="border-top:1px dahsed; text-align:right; padding-top:5px">
                            <?=$sale->cash?>
                        </td>
                    </tr>
                    <tr>
