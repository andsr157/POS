        	...
        	<div class="col-12 table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                                <button type="button" class="btn btn-edit btn-icons btn-rounded btn-secondary" data-toggle="modal" data-target="#modal-detail" id="dtl_set"
                            ...
                            <a href="<?=base_url('stock/in/del/'.$data->stock_id.'/'.$data->item_id)?>">
